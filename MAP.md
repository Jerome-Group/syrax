...
| Lane monitor | The rationed lane's counters, which rungs stand down or have rotted, the usage report, and the three tools served over MCP | `src/monitor/lane-monitor.ts` |
